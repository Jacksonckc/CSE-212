...
# Defect(s) Found: 
# enqueue function is inserting the new player to the beginning instead of the end. 
...
#print(players)    
# Defect(s) Found: 
# When 0 is passed in as the turns parameter, this person should be in the loop forever but it's not.
print("=================")
